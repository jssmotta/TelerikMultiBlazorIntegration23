...
public partial class Products
{
    ...
    private List<SalesByDateViewModel> sales = new();
    private List<ProductDto> products = new();
    private List<ProductDto> productsData = new();
    int PageSize = 8;
    int CurrentPage = 1;
    public string FilterText { get; set; } = string.Empty;
    TelerikChart BubbleRef { get; set; } = null!;
    public List<int?> PageSizes = new() { 2, 4, 6, 8, null };
    ...
    public List<ModelBubbleData> Series1Data = new()
    {
    ...
    public List<ModelBubbleData> Series2Data = new()
    {
